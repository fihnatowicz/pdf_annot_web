var pdf = new PDFAnnotate('pdf-container', 'https://raw.githubusercontent.com/fihnatowicz/pdf_test/master/sample.pdf', {
...
function getScaleFromUrl(){
	...
	var scale = Number(url.searchParams.get("scale"));
	$('#scale').val(scale);
	return scale;
}
...
function setScale(value){
	var url = new URL(window.location.href);
	url.searchParams.set("scale", value);
